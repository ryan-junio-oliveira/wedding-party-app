    ...
    <header class="bg-white shadow">
        <div class="container mx-auto py-6 px-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-4">
                ...
                <a href="{{ route('suppliers.index') }}" class="text-gray-700 hover:text-blue-600">Suppliers</a>
                <a href="{{ route('family.create') }}" class="text-gray-700 hover:text-blue-600">Register Family</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden">
            <nav class="flex flex-col px-4 py-2 space-y-1">
                <!-- <a href="{{ route('family.index') }}" class="block text-gray-700 hover:text-blue-600">Dashboard</a>
                <a href="{{ route('suppliers.index') }}" class="block text-gray-700 hover:text-blue-600">Suppliers</a>
                <a href="{{ route('family.create') }}" class="block text-gray-700 hover:text-blue-600">Register Family</a>
                <a href="{{ route('about') }}" class="block text-gray-700 hover:text-blue-600">About Us</a>
                ...
                <a href="" class="block text-gray-700 hover:text-blue-600">Fornecedores</a>
                <a href="" class="block text-gray-700 hover:text-blue-600">Registrar Familia</a>
            </nav>
        </div>
    </header>
